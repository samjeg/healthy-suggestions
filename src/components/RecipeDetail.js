...
const RecipeDetail = () => {
	return (  
        ...
        <article>
            ...
            <img class="img" alt="no image" src="./images/honza-vojtek-A39EqNtDpZs-unsplash.jpg" align="Top">     
            ...
            <section class="prep-info">
                <div class="container-2">
                    <img class="img-2" alt="no image available" src="./images/dragne-marius-ennARkXrF74-unsplash.jpg">
                </div>
